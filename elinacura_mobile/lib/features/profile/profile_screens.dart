...
import 'health_bento.dart';
import 'profile_bento.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ListView(
          ...
          children: [
            ...
            // ── Variable-height bento metric grid (inline number spinners)
            HealthBentoGrid(
              onLog: (type) => _logSingleVital(context, ref, type),
            ),
...
class _ProfileContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ProfileBentoBody(profile: profile, hasProfile: hasProfile);
  }
}
